...
class Correlation():
    ...
    def __init__(self,X):
        ...
        #self.__correlationMatrix = X.corr(method='pearson', min_periods=1)
    ...
    def getCorrMatrix(self):
        ...
        self.__matrix = None
        self.__meanMatrix = None
        self.__covMatrix = None
        self.__varMatrix = None
    ...
    def getLowCorrelationSnps(self, b=0.7, c = 0, up = 100, down = 0):
        
        return s.lowCorrelation(self.__correlationMatrix, b, c, up, down)

    def getHighCorrelationSnps(self, b=0.7, c = 0,up = 100, down = 0):

        return s.highCorrelation(self.__correlationMatrix, b, c, up, down)
